...
<body>
<form:form id="journalPapersConferenceForm" modelAttribute="journalPapersConferenceForm" method="post"
           name="journalPapersConferenceForm" action="${formAction}" enctype="multipart/form-data">
    <fieldset style="font-family: sans-serif;padding-top:5px">
        <input type="hidden" name="command" id="${ns}common"
               value="${journalPapersConferenceForm.command}"/>
        <input type="hidden" name="mode" id="${ns}mode" value="${journalPapersConferenceForm.mode}"/>
        ...
        <input type="hidden" id="${ns}_export_proof_participation"
               value="${journalPapersConferenceForm.journalPaperM.proofParticipationResource}"/>
        <input type="hidden" id="${ns}_export_proof_academic"
               value="${journalPapersConferenceForm.journalPaperM.proofAcademicResource}"/>
        <c:set var="userIdAsString">${user.userId}</c:set>
        <c:set var="havePermissionOnDocs" value="${journalPapersConferenceForm.mode=='edit' && journalPapersConferenceForm.journalPaperM.docType=='DRAFT' 
    								&& ( userIdAsString == journalPapersConferenceForm.journalPaperM.createdBy 
                       				|| userIdAsString==journalPapersConferenceForm.journalPaperM.updatedBy || journalPapersConferenceForm.journalPaperM.isdocAssign ) }"></c:set>
                ...
                <div class="accordion-group">
                    <div class="accordion-heading">
                        ...
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2"
                           href="#collapseOne">
                            ข้อมูลบทความวิจัย ( ประชุมวิชาการ )
                        </a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        <input type="text" class="form-control"
                                               value="${journalPapersConferenceForm.journalPaperM.journalPapersId}"
                                               disabled/>
                                    <td width="50%"></td>
                                </tr>
                                <tr valign="top">
                    ...
                    rgb(250, 250, 198);width:350px" class="form-control"
                                                   ...
                                                   value="${journalPapersConferenceForm.journalPaperM.journalPapersTypeShow}"/>
                                            <button style="margin-top: -8px"
                                                    onclick="${ns}journalPapersTypePopup('',true,1)"
                                                    type="button" class="btn btn-warning btn-small">...
                                            </button>
                                                <%--
                                           <span id="journalPapersType_assignShow">${journalPapersConferenceForm.journalPaperM.journalPapersTypeShow} </span>
                                            --%>
                                                <%--
                                                   <form:input path="journalPaperM.journalPapersType" cssStyle="display:inline;background-color: rgb(250, 250, 198);width:100px" cssClass="form-control"/>
                                                --%>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="20%">
                                        <label><span>ชื่อที่ประชุมทางวิชาการ:</span>
                                        </label>
                                    </td>
                                    <td width="30%">

                                        <form:input path="journalPaperM.journalPapersConference.conferenceName"
                                                    cssStyle="" cssClass="form-control"/>
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        <div>
                                            <form:hidden path="journalPaperM.journalPapersConference.level"/>
                                            <input type="text" style="background-color:
                    rgb(250, 250, 198);width:350px" class="form-control"
                                                   id="publishLevel_autocomplete" placeholder=""
                                                   value="${journalPapersConferenceForm.journalPaperM.journalPapersLevelShow}"/>
                                            <button style="margin-top: -8px"
                                ...
                                <tr>
                                    <td align="right" width="20%">
                                        <label><span>วันที่เริ่มต้น:</span>
                                        </label>
                                    </td>
                                    <td width="30%">
                                        <input type="text"
                                               value="${journalPapersConferenceForm.journalPaperM.journalPapersConference.startDateShow}"
                                               id="journalPaperM.journalPapersConference.startDateShow"
                                               name="journalPaperM.journalPapersConference.startDateShow"
                                               style="width:75px" class="form-control" placeholder="dd/mm/yyyy" readonly="readonly" />
                                            <%--
                                                 <form:input path="journalPaperM.journalPapersConference.startDate" cssStyle="width:75px" cssClass="form-control"/>
                                                  --%>
                                ...
                                <tr>
                                    <td align="right" width="20%">
                                        <label><span>วันที่สิ้นสุด:</span>
                                        </label>
                                    </td>
                                    <td width="30%">
                                        <input type="text"
                                               value="${journalPapersConferenceForm.journalPaperM.journalPapersConference.endDateShow}"
                                               id="journalPaperM.journalPapersConference.endDateShow"
                                               name="journalPaperM.journalPapersConference.endDateShow"
                                               style="width:75px" class="form-control" placeholder="dd/mm/yyyy" readonly="readonly" />
                                            <%--   <form:input path="journalPaperM.journalPapersConference.endDate" cssStyle="width:75px" cssClass="form-control"/>
                                        --%>
                                ...
                                <tr>
                                    ...
                                    <td width="30%">
                                        ...
                                        <form:input path="journalPaperM.journalPapersConference.page"
                                ...
                                <tr>
                                    <td align="right" width="20%">
                                        <label><span>สถานที่:</span>
                                        </label>
                                    </td>
                                    <td width="30%">

                                        <form:input path="journalPaperM.journalPapersConference.location" cssStyle=""
                                ...
                                <tr>
                                    <td align="right" width="20%">
                                        <label><span>จังหวัด/เมือง:</span>
                                        </label>
                                    </td>
                                    <td width="30%">

                                        <form:input path="journalPaperM.journalPapersConference.cityName"
                                                    cssClass="form-control"/>
                                ...
                                <tr>
                                    <td align="right" width="20%">
                                        <label><span>ประเทศ:</span>
                                        </label>
                                    </td>
                                    <td width="30%">
                                        <div>
                                            <form:hidden path="journalPaperM.journalPapersConference.country"/>
                                            <input type="text" style="background-color: 
                    rgb(250, 250, 198);width:120px" class="form-control"
                                                   id="country_assign_autocomplete" placeholder=""
                                                   value="${journalPapersConferenceForm.journalPaperM.journalPapersConference.countryShow}"/>
                                            <button style="margin-top: -8px"
                                                    onclick="${ns}countryPopup('',true,1)" type="button"
                                                    class="btn btn-warning btn-small">...
                                            </button>
                                                <%--
                   <span id="country_assignShow">${journalPapersConferenceForm.journalPaperM.journalPapersConference.countryShow} </span>
                     ...
                     <form:input path="rewardM.rewardCountry" cssStyle="display:inline;background-color: rgb(250, 250, 198);width:100px" cssClass="form-control"/>
                      --%>
                                            ...
                                            <%--
                       <form:input path="journalPaperM.journalPapersConference.country" cssStyle="display:inline;background-color: rgb(250, 250, 198);width:100px" cssClass="form-control"/>
                        --%>
            ...
            <tr>
             ...
             --%>
                                    ...
                                    <td width="80%" colspan="3">
                                        <div>
                                            ...
                                            <input type="text" style="background-color: rgb(250, 250, 198);width:350px"
                                                   ...
                                                   value="${journalPapersConferenceForm.journalPaperM.organizationShow}"
                                                   placeholder=""/>
                                            <button style="margin-top: -8px"
                                                ...
                                                <%--
                   <span id="organizationId_assignShow">${journalPapersConferenceForm.journalPaperM.organizationShow}</span>
                    --%>
                                                <%--
                    ...
                    rgb(250, 250, 198);width:350px" class="form-control"
                                                   ...
                                                   value="${journalPapersConferenceForm.journalPaperM.researchGroupShow}"/>
                                            <button style="margin-top: -8px"
                                                    onclick="${ns}researchGroupPopup('',true,1)"
                                                    type="button" class="btn btn-warning btn-small">...
                                            </button>
                                                <%--
                   <span id="researchGroupId_assignShow">${journalPapersConferenceForm.journalPaperM.researchGroupShow} </span>
                    --%>
                                                <%--
                      <form:input path="journalPaperM.researchGroupId" cssStyle="display:inline;background-color: rgb(250, 250, 198);width:100px" cssClass="form-control"/>
                      --%>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    rgb(250, 250, 198);width:350px" class="form-control"
                                                   ...
                                                   value="${journalPapersConferenceForm.journalPaperM.researchProjectShow}"/>
                                            <button style="margin-top: -8px"
                                                    onclick="${ns}researchProjectPopup('',true,1)"
                                                    type="button" class="btn btn-warning btn-small">...
                                            </button>
                                                <%--
                   <span id="researchProjectId_assignShow">${journalPapersConferenceForm.journalPaperM.researchProjectShow} </span>
             
                      <form:input path="journalPaperM.researchProjectId" cssStyle="display:inline;background-color: rgb(250, 250, 198);width:100px" cssClass="form-control"/>
                   --%>
                                        </div>
                                    </td>
                                </tr>
              ...
              <span id="${ns}doctype_assign_list">
               <c:if test="${not empty journalPapersConferenceForm.journalPaperM.docAssignMappings}">
                   <table class="table table-hover table-striped table-bordered table-condensed" border="0"
                          style="width:30%;font-size: 12px">
                       <c:forEach items="${journalPapersConferenceForm.journalPaperM.docAssignMappings}"
                                    ...
                                    <td align="center" colspan="4" width="20%">
                                        ...
                                        <c:if test="${mode=='edit'}">
                                            <c:if test="${havePermissionOnDocs}">
                                                ...
                                                <c:if test="${journalPapersConferenceForm.journalPaperM.flag=='0'}">
                                                    ...
                                                    <jsp:attribute name="value">
                                                        <c:out value="${journalPapersConferenceForm.journalPaperM.journalPapersId}"/>
                                                    </jsp:attribute>
                                                    </portlet:param>
                                                ...
                                                <button class="btn btn-danger" type="button"
                                                        onclick='return ${ns}confirmDelete("
                                                            <portlet:actionURL>
                                                                ...
                                                                <portlet:param name="pageInit"
                                                                               value="journalPapersConferenceList"/>
                                                                <portlet:param name="journalPapersId">
                                                                    <jsp:attribute name="value">
                                                                        <c:out value="${journalPapersConferenceForm.journalPaperM.journalPapersId}"/>
                                                                    </jsp:attribute>
                                                    ...
                                                    <c:if test="${journalPapersConferenceForm.journalPaperM.flag=='1'}">
                                                        ลบ
                                                    </c:if>
                                                    <c:if test="${journalPapersConferenceForm.journalPaperM.flag=='0'}">
                                                        ลบ ถาวร
                ...
                <div class="accordion-group">
                    ...
                    rgb(250, 250, 198);" class="form-control"
                                                            ...
                                                            <button id="${ns}researcherListAll"
                                                                ...
                                                                <%--
                   <span id="journalPapersWriterId_assignShow"></span>
                    --%>
                                                        </div>
                                                    </td>
                                                </tr>
                        			...
                        			<label>เป็นผู้เขียนหลัก?:<span style="color: red;font-size: 50;"> </span>
                                                    ...
                                                    <td width="70%" colspan="3">
                                                        <div>
                                                            ...
                                                            <c:if test="${not empty journalPapersConferenceForm.journalPaperM.journalPapersWriters}">
                                                                <c:forEach items="${journalPapersConferenceForm.journalPaperM.journalPapersWriters}"
                                                                           var="journalPapersWriter" varStatus="loop">
                ...
                <span sytle="padding-left:20px">
                 <c:if test="${journalPapersConferenceForm.mode=='edit'}">
                     <%--
                  <button type="button" onclick="${ns}exportProofFile('participation')" class="btn">Export Participation</button>
        ...
        <table class="table table-striped table-bordered table-condensed" border="1" style="font-size: 12px">
            ...
            <tbody>
            <c:if test="${not empty journalPapersConferenceForm.journalPaperM.journalPapersDocuments}">
                <c:forEach items="${journalPapersConferenceForm.journalPaperM.journalPapersDocuments}"
                           var="journalPapersDocument" varStatus="loop">
...
<script>
    $(document).ready(function () {
        var _path = "${url}";
        $('input[id="journalPaperM.journalPapersConference.endDateShow"]').datepicker({
            showOn: "button",
            buttonImage: '<c:url value="/resources/images/calendar.gif"/>',
            buttonImageOnly: true,
            dateFormat: "dd/mm/yy"
        });
        $('input[id="journalPaperM.journalPapersConference.startDateShow"]').datepicker({
            showOn: "button",
            buttonImage: '<c:url value="/resources/images/calendar.gif"/>',
            buttonImageOnly: true,
            dateFormat: "dd/mm/yy"
        ...
        $('#publishLevel_autocomplete').autocomplete({
            ...
            select: function (event, ui) {
                ...
                this.value = ui.item.name;
                $('input[id="journalPaperM.journalPapersConference.level"]').val(ui.item.id);
        ...
        $('#country_assign_autocomplete').autocomplete({
            source: function (request, response) {
                var countryM = {
                    keySearch: request.term
                }
            ...
            select: function (event, ui) {
                this.value = ui.item.name;
                $('input[id="journalPaperM.journalPapersConference.country"]').val(ui.item.id);
                $("#country_assignShow").html(" " + ui.item.name + " ");
                return false;
            },
            open: function () {
                $(this).removeClass("ui-corner-all").addClass("ui-corner-top");
        ...
        $('#journalPaperM\\.budgetYear').keyup(function () {
            var dInput = this.value;
            // alert(dInput.length)
            if ($.trim(dInput).length > 0 && !${ns}validateDigitOnly(dInput)) {
                //alert('กรอก  เฉพาะตัวเลขเท่านั้น.');
        ...
        if (obj != null) {
            for (var i = 0; i < obj.length; i++) {
                ...
                str = str + "" +
                            ...
                            //" <td style=\"text-align: left\">"+$.trim(obj[i].description)+"</td> "+
                        " <td style=\"text-align: center\">" +
    ...
    function ${ns}selectcountry(objID) {
        ...
        ResearchAjax.findCountryById(objID, {
            callback: function (data) {
                $('input[id="journalPaperM.journalPapersConference.country"]').val(objID)
                $("#country_assign_autocomplete").val(data.countryNameTh);
                bootbox.hideAll();
            }
        });
    }
    ...
    function ${ns}selectpublishLevel(objID) {
        ...
        ResearchAjax.findPublishLevelById(objID, {
            callback: function (data) {
                $('input[id="journalPaperM.journalPapersConference.level"]').val(objID)
