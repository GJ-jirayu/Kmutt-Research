...
var _ndgName = document.getElementById("ntcDownloadSubGroup.ndgName");
...
<form:hidden path="ntcDownloadSubGroup.ndgId"/>
<form:hidden path="ntcDownloadSubGroup.ndgCode"/>
<form:hidden path="ntcDownloadSubGroup.ndgLevel"/>
<form:hidden path="ntcDownloadSubGroup.ndgParent" id="ndgParent"/>
                  ...
                  <td colspan="3" style="border:#0e589e 1px solid"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="5" class="textlineblue3"> 
                          <tr> 
                            <td width="40%" align="right" bgcolor="#F0F0F0" class="font_topic_detail">หมวดหมู่ย่อยหลัก(*) :</td>
                                      ...
                                      <tr>
                                        <td>
										  <c:if test="${downloadAdminform.mode=='add' || downloadAdminform.mode=='edit'}">
    											<form:select path="ndgIdSelect"  id="ndgIdSelect">
                                ...
                                <tr>
                                  <td width="550"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td>
										  <c:if test="${downloadAdminform.mode=='add' || downloadAdminform.mode=='edit'}">
    												<form:input path="ntcDownloadSubGroup.ndgName"/>
    									  </c:if>
										  <c:if test="${downloadAdminform.mode=='view'}">
    											&nbsp;<c:out value="${downloadAdminform.ntcDownloadSubGroup.ndgName}"></c:out>
										  </c:if>
										 </td>
                                      </tr> 
                                  </table></td>
                                ...
                                <tr>
                                  <td width="550"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td>
										  <c:if test="${downloadAdminform.mode=='add' || downloadAdminform.mode=='edit'}">
    												<form:textarea path="ntcDownloadSubGroup.ndgDesc" cssStyle="width:300px;"/>
    									  </c:if>
										  <c:if test="${downloadAdminform.mode=='view'}">
    											&nbsp;<c:out value="${downloadAdminform.ntcDownloadSubGroup.ndgDesc}"></c:out>
										  </c:if>
										 </td>
                                      </tr>
                                  </table></td>
                          ...
                          <tr> 
                            <td width="85%" align="center"><table width="15%" border="0" cellspacing="0" cellpadding="5">
                               ...
                               <td  colspan="2" align="center">
                                  <c:if test="${downloadAdminform.mode=='add' || downloadAdminform.mode=='edit'}"> 
                                      <label>
                                  		<input type="image" src='<%=renderResponse.encodeURL(renderRequest.getContextPath()+"/images/ok.jpg") %>'    alt="" onclick="return <portlet:namespace />doAction('doSaveDownloadSubGroup','${downloadAdminform.mode}')"/>
                                  	  </label>
                                  </c:if>
                                  <c:if test="${downloadAdminform.mode=='view'}">
                                  	  <label>
