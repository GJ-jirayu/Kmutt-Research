      ...
      <td valign="top"><table width="950" border="0" align="center" cellpadding="20" cellspacing="0">
        ...
        <tr>
          ...
          <a href="<portlet:renderURL>
                      ...
                      </portlet:renderURL>" title="เพิ่มหมวดหมู่หลัก">
             เพิ่มหมวดหมู่หลัก
          </a>
      </td>
                </tr>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr  style="color:#FFFFFF" class="textsmall12">
                      <td width="150" background='<%=renderResponse.encodeURL(renderRequest.getContextPath()+"/images/approval_02.jpg") %>'><img src='<%=renderResponse.encodeURL(renderRequest.getContextPath()+"/images/approval_01.jpg") %>' alt="" width="13" height="31" align="absmiddle" /><strong>&nbsp;&nbsp;&nbsp;&nbsp;รหัสหมวดหมู่หลัก</strong></td>
                      <td align="left" background='<%=renderResponse.encodeURL(renderRequest.getContextPath()+"/images/approval_02.jpg") %>'><strong>ชื่อหมวดหมู่หลัก</strong></td>
       ...
       <c:choose>
		...
		<a href="<portlet:renderURL>
          ...
          <td width="44" align="center" bgcolor="${col4}">
          	<span style="cursor: pointer;text-decoration: underline" title="ลบ"  onclick='return <portlet:namespace />confirmDelete("<portlet:actionURL><portlet:param name="action" value="deleteDownloadGroup"/><portlet:param name="ndgId"><jsp:attribute name="value"><c:out value="${ntcdownloadgroup.ndgId}"/></jsp:attribute></portlet:param></portlet:actionURL>")'>ลบ</span>
           </td>                
       </tr>
    </c:forEach>
    </table>
       ...
       <%
         ...
         <%}%> 
                        ...
                        <% if(pagingScript_recordCount==0){%>
                         <tr>
       <td colspan="5" 
           align="center" class="textlineblue3">ไม่พบข้อมูล</td>
