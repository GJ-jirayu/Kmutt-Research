...
<form:form  id="positionMasterForm" modelAttribute="positionMasterForm" method="post"  name="positionMasterForm" action="${formAction}" enctype="multipart/form-data">
  ...
  <strong>Import Success !</strong>
            	 ...
            	 <tr>
              		<td align="right" width="20%">
                        <span>
                        	<label>ตำแหน่งทาง:<span style="color: red;font-size: 50;"> </span> 
                        	</label>
                        </span> 
             	 	</td>
              	 	<td width="80%" colspan="3">
                    	<div> 
						 <form:radiobutton path="positionM.positionType" value="1" cssClass="form-control"/>วิชาการ&nbsp;&nbsp;&nbsp;
						<form:radiobutton path="positionM.positionType" value="2" cssClass="form-control"/>สายงาน
                       </div>
              		</td> 
            	</tr>  
              <tr>
